...
def create_jms_resource(resource_type: str, name: str) -> str:
    return f"create-custom-resource --restype {resource_type} --factoryclass=org.apache.activemq.jndi.JNDIReferenceFactory {name}"
